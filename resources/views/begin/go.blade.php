...
@section('content')
    <div class="container text-center text-white">
        ...
        <div class="my-5">
            <h1 class="mb-4">{{ __('Identity') }}</h1>
            <p class="lead">
                {{ __('Certain aspects of how your match identifies may be important to you. In the first few questions, let us know and we\'ll factor your preferences into your match. You can always share "no preference"!') }}
            </p>
        </div>
        <div class="my-5">
            <div>
                <a href="{{ route('match.begin.gender') }}">
