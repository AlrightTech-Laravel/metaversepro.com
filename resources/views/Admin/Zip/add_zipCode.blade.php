                 ...
                 <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center">
                            <h1><b>Add New Code</b></h1>
                        </div>

                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                     <form method="POST" action="{{ URL::to('add-zipcode') }}">
                                        @csrf()

                                        <div class="mb-3">
                                            <label class="form-label">Zip Code</label>
                                            <input id="zipcode" class="form-control form-control-lg @error('zipcode') is-invalid @enderror" value="{{ old('zipcode') }}" type="number" name="zipcode" placeholder="e.g 12345" required  autocomplete="zipcode" autofocus/>
